...
- `==================== START: .semad-core/folder/filename.md ====================`
- `==================== END: .semad-core/folder/filename.md ====================`

When you need to reference a resource mentioned in your instructions:

- Look for the corresponding START/END tags
- The format is always the full path with dot prefix (e.g., `.semad-core/personas/analyst.md`, `.semad-core/structured-tasks/create-story.yaml`)
...
- `dependencies.utils: template-format` → Look for `==================== START: .semad-core/utils/template-format.md ====================`
- `dependencies.utils: create-story` → Look for `==================== START: .semad-core/structured-tasks/create-story.yaml ====================`
