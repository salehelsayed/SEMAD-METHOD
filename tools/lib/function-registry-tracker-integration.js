...
// const { getTracker } = require(resolveModule('utils/memory-compatibility-wrapper', '../../semad-core/utils/memory-compatibility-wrapper'));
// const simpleMemory = require(resolveModule('utils/simpleMemory', '../../semad-core/utils/simpleMemory'));
...
const TRACKER_FUNCTIONS = {
  ...
  'simpleMemory.saveContext': async (params) => {
    const simpleMemory = require('../../semad-core/utils/simpleMemory');
  ...
  trackProgress: async (workflow, task, status, notes) => {
    const { getTracker } = require('../../semad-core/utils/memory-compatibility-wrapper');
