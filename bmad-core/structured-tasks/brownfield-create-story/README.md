# Brownfield Create Story Task (Modular)
...
```
node tools/assemble-structured-content.js task structured-tasks/brownfield-create-story/index.yaml structured-tasks/brownfield-create-story.yaml
```
