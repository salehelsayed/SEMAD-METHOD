...
commands:  
  ...
  - validate-epic {epic}: "execute: node scripts/validate-epic-contract.js --file {epic} → tracker.log('Validating epic', 'info') → execute: node .bmad-core/utils/track-progress.js observation pm 'Epic validation report generated' → tracker.completeCurrentTask('epic validated')"
